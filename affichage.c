...
void afficherAide() {
    ...
    printf("Commandes :\n");
    printf("- Utilisez les coordonnees pour deplacer vos pions.\n");
...
void sauvegarderPartie(Damier *damier, Joueur joueur1, Joueur joueur2, int option) {
    ...
    snprintf(source, sizeof(source), "./%s/%s_%s.plato", "Sauvegarde", joueur1.surnom, joueur2.surnom);
...
void sauvegarderRevisualisation(Damier *damier, Joueur joueur1, Joueur joueur2, int option) {
    ...
    snprintf(source, sizeof(source), "./%s/%s_%s.plato", "Revisualisation", joueur1.surnom, joueur2.surnom);
